...
export default function AboutMe(){
    return (
        <section id="aboutme" className="text-gray-400 dark:bg-gray-900 body-font pt-16">
            <div className="container px-5 pb-24 mx-auto">
                <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-700 dark:text-white font-bold text-center font-mono">About Me</h1>
                <div className="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
                    <p className="leading-relaxed text-lg text-gray-700 dark:text-gray-400 font-mono">
                    ...
                    <p className="leading-relaxed text-lg mt-2 text-gray-700 dark:text-gray-400 font-mono">
